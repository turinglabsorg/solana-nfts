...
const nftOwner = wallet.publicKey
const collectionMint = JSON.parse(fs.readFileSync('./configs/collectionMint.json', 'utf-8'))
const collectionUpdateAuthority = JSON.parse(fs.readFileSync('./configs/collectionUpdateAuthority.json', 'utf-8'))
const minted = await transactionBuilder()
